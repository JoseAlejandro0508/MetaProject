...
public class DBContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Plan>().HasData(
            new Plan { IDPlan = 1, Name = "Trump Turnberry", Price = 50000, MaxQuantity = 100, DaysActive = 30, DailyBenefit = 2000, TotalBenefit = 60000, Description = "Un resort de golf icónico y legendario en la costa escocesa. Turismo de lujo internacional.", DailyProfitPercentage = 4, ImageUrl = "/plans/trump-turnberry.webp" },
            new Plan { IDPlan = 2, Name = "Trump Tower", Price = 150000, MaxQuantity = 100, DaysActive = 30, DailyBenefit = 9000, TotalBenefit = 270000, Description = "El rascacielos insignia en la Quinta Avenida. Alquiler de espacios comerciales y rentas de oficinas de lujo.", DailyProfitPercentage = 6, ImageUrl = "/plans/trump-tower.webp" },
            new Plan { IDPlan = 3, Name = "Mar-a-Lago", Price = 240000, MaxQuantity = 100, DaysActive = 30, DailyBenefit = 19200, TotalBenefit = 576000, Description = "Un club privado histórico y la residencia principal de Trump.", DailyProfitPercentage = 8, ImageUrl = "/plans/mar-a-lago.webp" },
            new Plan { IDPlan = 4, Name = "40 Wall Street", Price = 350000, MaxQuantity = 100, DaysActive = 30, DailyBenefit = 31500, TotalBenefit = 945000, Description = "Un edificio de oficinas de 71 pisos en el distrito financiero. Arrendamiento comercial.", DailyProfitPercentage = 9, ImageUrl = "/plans/40-wall-street.webp" },
            new Plan { IDPlan = 5, Name = "Trump Casino", Price = 500000, MaxQuantity = 100, DaysActive = 30, DailyBenefit = 50000, TotalBenefit = 1500000, Description = "Un casino de juegos tragamonedas, poker y mucho más.", DailyProfitPercentage = 10, ImageUrl = "/plans/trump-casino.webp" },
            new Plan { IDPlan = 6, Name = "555 California Street", Price = 800000, MaxQuantity = 100, DaysActive = 30, DailyBenefit = 96000, TotalBenefit = 2880000, Description = "Uno de los edificios más altos y valiosos de la costa oeste. Alquiler de oficinas.", DailyProfitPercentage = 12, ImageUrl = "/plans/555-california.webp" },
            new Plan { IDPlan = 7, Name = "Trump International Hotel & Tower Chicago", Price = 1200000, MaxQuantity = 100, DaysActive = 30, DailyBenefit = 180000, TotalBenefit = 5400000, Description = "Un rascacielos de uso mixto junto al río Chicago. Hotel y condominios.", DailyProfitPercentage = 15, ImageUrl = "/plans/trump-chicago.webp" },
            new Plan { IDPlan = 8, Name = "Trump International Hotel Las Vegas", Price = 5000000, MaxQuantity = 100, DaysActive = 30, DailyBenefit = 1500000, TotalBenefit = 45000000, Description = "Una torre dorada hotel y condo-hotel. Operación hotelera y comisiones.", DailyProfitPercentage = 30, ImageUrl = "/plans/trump-vegas.webp" }
        );
